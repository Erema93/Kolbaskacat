...
try:
    ADMIN_CHAT_ID = int(ADMIN_CHAT_ID)  # Приведение к числу
except ValueError:
...
# Счетчик заявок (лучше заменить на базу данных)
request_counter = 0
...
def main():
    ...
    application.add_handler(TypeHandler(Exception, error))  # Исправлено добавление обработчика ошибок
